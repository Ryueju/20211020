...
public class ShootingGame extends JFrame { // GUI형태로 구현하기 위해서 JFrame상속해줌
	...
	private Image mainScreen = new ImageIcon("src/main/java/main.gif").getImage();
	private Image loadingScreen = new ImageIcon("src/main/java/loading2.gif").getImage();
	private Image gameScreen = new ImageIcon("src/main/java/pixel22.gif").getImage();
	...
	public void paint(Graphics g) {
		/*
		 * 더블 버퍼링 : 컴퓨터가 그래픽을 표시하기 위해 일정시간마다 화면을 뿌려주는데, 지속적으로 갱신하다보면 깜빡임 현상이 나타남
		 * 이것을 방지하기 위해 사용됨
		 */
